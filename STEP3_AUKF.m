%% FC2 Ablation Test: TS-LSTM + AUKF
clear; clc; close all;
...
out_dir = fullfile('消融实验', 'TS_LSTM_AUKF');
if ~exist(out_dir, 'dir')
    mkdir(out_dir);
end

RESULT = struct();
RESULT.method = 'TS-LSTM + AUKF';
...
writetable(T, fullfile(out_dir, 'metrics_TS_LSTM_AUKF_FC2.csv'));

disp('>>> TS-LSTM + AUKF FC2 results saved.');
